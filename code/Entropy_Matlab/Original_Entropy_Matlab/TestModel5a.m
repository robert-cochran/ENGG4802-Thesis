...
BaseFile1   = 'data\sherlockholmes2.txt';   
BaseFile2 = 'data\drseusscat.txt';
OutputFile1 = 'output\sherlock2';  
OutputFile2 = 'output\drseusscat';  
CombFile = 'Sherlock2Seuss'; 
RunNo = 7;
