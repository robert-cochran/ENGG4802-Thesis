function [Hp, Hea] = fastentropyblock(Hp, i, ia, Ablock, Naw, CSymbol, M, ap, bp, cp)

   [Da] = comprankdistance(Ablock, Naw, CSymbol);
    ...
    if isempty(Da)
        ...
        fprintf('A) For calculated Dmean=%4.3f, we have Kest=%4.3f,\n',dmeantest, Kest);  
        ...
        %
            ...
            Hea = -He;
            fprintf('A) Combined file (TS + DS): Hea(%d)(%4.2f) = %5.4f \n',i, Kest, Hea);    % 4.2523 
